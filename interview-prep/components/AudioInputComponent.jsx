...
if(processing){
  return (
    <div role="status">
    <svg aria-hidden="true" class="inline w-28 h-28
     text-gray-200 animate-spin dark:text-white-600 fill-green-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
   ...
   <h1 className='bg-transparent'>
      ...
      <FaMicrophoneLinesSlash  className='bg-transparent'/>
      </div> :  
      ...
      <h1  className='bg-transparent'>
         ...
         <FaMicrophoneLines  className='bg-transparent' />
         </div>
